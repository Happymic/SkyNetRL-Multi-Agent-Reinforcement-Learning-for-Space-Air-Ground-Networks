...
class Config:
    def __init__(self):
        ...
        # Training settings
        self.num_episodes = 1000  # Increased for better learning
        self.batch_size = 128    # Increased for more stable learning
        self.buffer_size = 1000000  # Increased for better experience replay
        self.log_frequency = 10   # Log more frequently
        self.eval_frequency = 100  # Evaluate less frequently
        self.eval_episodes = 5
        self.save_frequency = 100

        # Exploration settings
        self.exploration_noise = 0.1  # Reduced for more stable learning
        self.exploration_decay = 0.995  # Slower decay
